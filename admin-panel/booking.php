                        ...
                        <table id="example" class="table table-bordered table-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                ?>
                                  ...
                                  <td>
                                  <a href="?id=<?php echo $row['id']?>" class="btn btn-info btn-sm active"><i class="mdi mdi-account-edit"></i></a>

                                  <a href="?id=<?php echo $row['id']?>" class="btn btn-danger btn-sm active"><i
